...
import com.romani.chapterone.utilities.JSON.MoviesList;
...
public class Session8Activity extends AppCompatActivity {
    ...
    public void parseJSON()
    {
        try {
            ...
            for (int i = 0; i < jsonArray.length(); i++)
            {
                ...
                movie.setRank(movieObj.getString("rank"));
                ...
                myTXT.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (x < movies.size())
                        {
                            myTXT.setText(movies.get(x).getTitle());
                        }
                    }
                });
            }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.session8_activity);

        myTXT = findViewById(R.id.moviesListTXT);
        parseJSON();
    }
